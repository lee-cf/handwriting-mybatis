...
import cn.lcf.mybatis.reflection.ArrayUtil;
...
public class Jdbc3KeyGenerator implements KeyGenerator{
    ...
    private Map.Entry<String, KeyAssigner> getAssignerForParamMap(Configuration config, ResultSetMetaData rsmd,
    ...
    private Map.Entry<String, KeyAssigner> getAssignerForSingleParam(Configuration config, ResultSetMetaData rsmd,
